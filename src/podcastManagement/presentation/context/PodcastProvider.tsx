...
export const PodcastProvider: React.FC<PodcastProviderProps> = ({ children }) => {
    ...
    const getPopularPodcastsUseCase = new GetPopularPodcastsUseCase(podcastService);
...
export const usePodcastUseCases = () => {
    ...
    if (!context) {
        throw new Error('usePodcastUseCases debe ser usado dentro de PodcastProvider');
    }
    return context;
};
