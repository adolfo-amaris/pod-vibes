...
describe("PodcastDetail", () => {
    it("debería crear una instancia válida con datos correctos", () => {
        const episodes = [
            new Episode("1", "Episodio 1", "Descripción 1", 1200, "audio1.mp3", "2023-12-01"),
            new Episode("2", "Episodio 2", "Descripción 2", 1500, "audio2.mp3", "2023-12-02"),
        ];
    ...
    it("debería lanzar error si faltan datos obligatorios", () => {
        expect(() => new PodcastDetail("", "Podcast Name", "Descripción", "artwork.jpg", [])).toThrow();
        expect(() => new PodcastDetail("123", "", "Descripción", "artwork.jpg", [])).toThrow();
    });
});
