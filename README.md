...
6. <ins>Cobertura de Tests por Capa</ins>
7. <ins>Estructura del Proyecto</ins>
8. <ins>Automatización de estándares y procesos de CI/CD</ins>
9. <ins>Instalación y Uso</ins>
10. <ins>Conclusión</ins>
11. <ins>Próximos Pasos</ins>
...
1. **Principio de Responsabilidad Única (SRP)**
   ...
   - _Definición:_ Cada módulo o clase debe tener una única razón para cambiar.
...
4. **Principio de Segregación de Interfaces (ISP)**
   _Definición:_ Ningún módulo debe depender de métodos que no utiliza.
